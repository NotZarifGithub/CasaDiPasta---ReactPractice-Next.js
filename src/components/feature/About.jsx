...
const About = () => {
  return (
    <section>
      <div className='flex flex-col items-center justify-center lg:flex-row bg-[#36454f] border-b'>
        ...
        {/* ABOUT CONTENT */}
        <div className="flex flex-col items-center justify-center p-[30px] lg:p-[40px] max-w-[500px] md:max-w-[600px] lg:items-start">
